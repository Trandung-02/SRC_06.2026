...
export const heLanding: LandingStrings = {
  ...
  steps: {
    ...
    subtitle:
      'תהליך האימות שלנו נועד לשמור על שלמות התג המאומת לעסקים. התחילו בהשלמת פרטי ההפעלה. לפרטי מחיר וזכאות ראו שאלות נפוצות.',
    items: [
      {
        title: 'התחילו הפעלה.',
        description:
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: 'האם אפשר לבטל את התוכנית?',
        answer:
          'כן. ניתן לבטל או לשנות את התוכנית בהגדרות Meta Verified. חלק מההטבות עשויות להימשך עד סוף תקופת החיוב הנוכחית.',
      },
      {
