...
export const zhHantLanding: LandingStrings = {
  ...
  testimonials: {
    ...
    items: [
      {
        quote: '認證徽章讓我們在 Facebook 上的第一次互動就贏得顧客信任。',
        author: 'Lan Nguyen',
        role: '時尚零售店主',
      },
      {
        quote: '啟用 Meta Verified 後，詢問「這是官方粉絲專頁嗎？」的訊息變少了。',
        author: 'Minh Tran',
        role: '行銷總監',
      },
      {
        quote: '啟用流程清楚，需要更新商家資訊時支援也很迅速。',
        author: 'Huong Pham',
        role: '美妝品牌共同創辦人',
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        question: '與免費驗證有何不同？',
        answer:
          'Meta Verified for Business 是包含徽章、品牌保護與額外支援的付費訂閱，與特定產品情境中的免費驗證不同。',
      },
    ],
  },
  footer: {
